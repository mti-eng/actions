...
| Action | Directory | Purpose |
|--------|-----------|---------|
| Install Dependencies | [install-dependencies](install-dependencies/) | Set up Python, optionally auth private packages, and pip install |
| Private Package Auth | [setup-private-install](setup-private-install/) | Configure gh credentials for private pip installs |
